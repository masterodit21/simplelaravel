                    ...
                    <div class="card-body">
                        ...
                        @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                <input type="text" name="NamaMotor" value="{{ old('NamaMotor', $motor->NamaMotor) }}" placeholder="Masukkan Nama Kendaraan">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                <input type="text" name="PlatNomor" value="{{ old('PlatNomor', $motor->PlatNomor) }}" placeholder="Masukkan Plat Nomor">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                <input type="text" name="HargaMotor" value="{{ old('HargaMotor', $motor->HargaMotor) }}" placeholder="Masukkan Harga Motor">
                                </div>
                            </div>
